...
games=pd.read_csv("TENNIS154.csv",low_memory=False)
players=pd.read_csv("eloCourtV111.csv",low_memory=False)
...
if __name__ == "__main__":
    for z in range(182488,len(games['ID1'])):
        ...
        players.to_csv('eloCourtV112.csv',index=False)